...
namespace Granular.Presentation.Tests
{
    ...
    public class DependencyPropertyCallbackTest
    {
        private class Element1 : DependencyObject
        {
            ...
            public static readonly DependencyProperty Value1InheritsProperty = DependencyProperty.Register("Value1Inherits", typeof(int), typeof(Element1), new FrameworkPropertyMetadata(0, FrameworkPropertyMetadataOptions.Inherits, propertyChangedCallback: PropertyChangedCallback, coerceValueCallback: (d, baseValue) => CoerceValueCallback(d, Element1.Value1InheritsProperty, baseValue)));
            public static readonly DependencyProperty Value1InheritsAttachedProperty = DependencyProperty.RegisterAttached("Value1InheritsAttached", typeof(int), typeof(Element1), new FrameworkPropertyMetadata(0, FrameworkPropertyMetadataOptions.Inherits, propertyChangedCallback: PropertyChangedCallback, coerceValueCallback: (d, baseValue) => CoerceValueCallback(d, Element1.Value1InheritsAttachedProperty, baseValue)));
        ...
        private class Element2 : Element1
        {
            ...
            public static readonly DependencyProperty Value2InheritsProperty = DependencyProperty.Register("Value2Inherits", typeof(int), typeof(Element2), new FrameworkPropertyMetadata(0, FrameworkPropertyMetadataOptions.Inherits, propertyChangedCallback: PropertyChangedCallback, coerceValueCallback: (d, baseValue) => CoerceValueCallback(d, Element2.Value2InheritsProperty, baseValue)));
            public static readonly DependencyProperty Value2InheritsAttachedProperty = DependencyProperty.RegisterAttached("Value2InheritsAttached", typeof(int), typeof(Element2), new FrameworkPropertyMetadata(0, FrameworkPropertyMetadataOptions.Inherits, propertyChangedCallback: PropertyChangedCallback, coerceValueCallback: (d, baseValue) => CoerceValueCallback(d, Element2.Value2InheritsAttachedProperty, baseValue)));
        }
