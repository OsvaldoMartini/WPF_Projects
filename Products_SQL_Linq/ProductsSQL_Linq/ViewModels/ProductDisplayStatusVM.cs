...
namespace Products_SQL_Linq.ViewModels
{
    ...
    public class ProductDisplayStatusVM : INotifyPropertyChanged
    {
        ...
        public bool ChkProductForAdd(ProductVM p)
        {
            int errCnt = 0;
        ...
        //check all product fields for validity
        public bool ChkProductForUpdate(ProductVM p)
        {
            int errCnt = 0;
            if (String.IsNullOrEmpty(p.ModelNumber))
            { errCnt++; ModelNumberBrush = errorBrush; }
