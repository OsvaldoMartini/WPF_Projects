...
namespace Products_SQL_Linq.ViewModels
{
    public class ProductDisplayVM : INotifyPropertyChanged
    {
        ...
        private readonly ProductDisplayStatusVM stat = new ProductDisplayStatusVM();
        public ProductDisplayStatusVM Stat { get { return stat; } }

        private ProductVM displayedProduct = new ProductVM();
        public ProductVM DisplayedProduct
        {
        ...
        public ProductDisplayVM()
        {
            ...
            messenger.Register("ProductSelectionChanged", (Action<ProductVM>)(param => ProcessProduct(param)));
            messenger.Register("SetStatus", (Action<String>)(param => stat.Status = param));
        } //ctor

        public void ProcessProduct(ProductVM p)
        {
